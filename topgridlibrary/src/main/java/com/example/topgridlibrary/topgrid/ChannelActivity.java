package com.example.topgridlibrary.topgrid;
...
import com.example.topgridlibrary.topgrid.adapter.DragAdapter;
import com.example.topgridlibrary.topgrid.adapter.OtherAdapter;
...
import com.example.topgridlibrary.topgrid.bean.NewsItemBean;
import com.example.topgridlibrary.topgrid.tools.SharedPreUtils;
import com.example.topgridlibrary.topgrid.view.DragGrid;
import com.example.topgridlibrary.topgrid.view.OtherGridView;
...
//		String channer=getIntent().getStringExtra("channel");
//		NewsItemBean bean=new Gson().fromJson(channer, NewsItemBean.class);
//		ChannelManage.setChannel(bean.getItems());
	...
	public void onItemClick(AdapterView<?> parent, final View view, final int position,long id) {
		...
		int i = parent.getId();
		if (i == R.id.userGridView) {//TODO position为 0的不可以进行任何操作
...
//			}
	...
	protected void onPause() {
		super.onPause();
		SharedPreUtils.put(this,"channel","1");
